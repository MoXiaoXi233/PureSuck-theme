...
function renderGithubError($message, $url = '')
{
    ...
    return '<div class="github-card github-card-error" role="status">'
        ...
        . '<div class="github-card-platform">GitHub</div>'
...
function renderGithubCard($url)
{
    ...
    if ($userInfo) {
        ...
        return '<a class="github-card" href="' . $link . '" target="_blank" rel="noopener noreferrer">'
            ...
            . '<span class="github-card-platform">GitHub Profile</span>'
            ...
            . '<span class="github-card-owner">github.com/' . $login . '</span>'
            . '</span>'
            . '</span>'
    ...
    return '<a class="github-card" href="' . $link . '" target="_blank" rel="noopener noreferrer">'
        ...
        . '<span class="github-card-header">'
        . '<span class="github-card-title-wrap">'
        . '<span class="github-card-title-row"><span class="github-card-title github-card-title-repo">' . $name . '</span><span class="github-card-badge github-card-badge-repo">Repo</span></span>'
        . '</span>'
        . '</span>'
        . '<span class="github-card-desc">' . $desc . '</span>'
        . '<span class="github-card-meta">'
        . '<span class="meta-item github-card-source"><i class="icon icon-github-circled"></i>GitHub</span>'
